...
const getFrameworkIconUrl = (icon: string) => {
  const images = {
    ...
    'openshift':
      'https://images.ctfassets.net/rj4r6yfcesw5/WymClub48oCM0cQKamAKS/bbe053282064e046e66d2e8ea836d436/openshift.png',
    'postgresql':
      'https://images.ctfassets.net/rj4r6yfcesw5/4j4CzmEjg4CqyiQ4qCO2eq/f843278027464af0173ac95caba1c58c/postgres.png',
    'prismic':
      'https://images.ctfassets.net/rj4r6yfcesw5/76Ogyky0iQSYYWmiuiGq60/88b1cb2e76b5749e2ac29a7b5d5e2916/prismic.png',
    'protractor':
      'https://images.ctfassets.net/rj4r6yfcesw5/2g691MGmkw26MQAGe8ueuC/e6cc79ddc0f34a9731bc67a51e51c692/protractor.png',
    'rabbitmq':
      'https://images.ctfassets.net/rj4r6yfcesw5/3Q1H5TMuaIUoEMCOSkgsIq/38a7ff5163046f1273f31acfe66800ba/rabbitmq.png',
    'react':
      'https://images.ctfassets.net/rj4r6yfcesw5/6Khn8L48laAoQuCkaouyQG/08e4cf1fe02bd945c23807d5a8f29e87/react.png',
    'restify':
      'https://images.ctfassets.net/rj4r6yfcesw5/572UfvNCK4kOEYWwy0u08i/c0fc3506ac26c2701fe489e4dc67e03f/resitfy.png',
    'rethinkdb':
      'https://images.ctfassets.net/rj4r6yfcesw5/6h0zebM6NaiOmE4M2SMWWQ/aa5ae0045a5744cd1751d6eb4e1094b7/rethinkdb.png',
    'vue':
      'https://images.ctfassets.net/rj4r6yfcesw5/5EBgyxee0oiGqqOmAEmAUq/af8d1ae7d3d578197205205b2c33e8ff/Vue.png',
  }
