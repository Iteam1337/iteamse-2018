export const pageOps = {
  ...
  hardwareText:
    'Iteam har lång erfarenhet av att installera och underhålla redundanta system för virtualisering. Vi är mest hemma i Microsoft Hyper-V kluster men klarar även andra.\nVi hjälper dig välja utrustning för just dina behov, vi är märkesoberoende även om vi har våra favoriter. Vi har erfarenhet av arbetsstationer och servrar från bl.a Dell, Lenovo, HP, Supermicro och är certifierade på QSAN för lagringslösningar.\n',
